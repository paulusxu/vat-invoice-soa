...
public interface InvoiceShopMapper {
    ...
    public int validationInvoice(@Param("lenovoid")String lenovoid,@Param("companyType")int companyType,@Param("customerName")String customerName,@Param("taxNo")String taxNo);
